 ...
 */
void log_red(const char *text) {
    printf("%s%s%s", ANSI_RED, text, ANSI_RESET);
}
 ...
 */
void log_green(const char *text) {
    printf("%s%s%s", ANSI_GREEN, text, ANSI_RESET);
}
 ...
 */
void log_yellow(const char *text) {
    printf("%s%s%s", ANSI_YELLOW, text, ANSI_RESET);
}
 ...
 */
void log_blue(const char *text) {
    printf("%s%s%s", ANSI_BLUE, text, ANSI_RESET);
}
 ...
 */
void log_magenta(const char *text) {
    printf("%s%s%s", ANSI_MAGENTA, text, ANSI_RESET);
}
 ...
 */
void log_cyan(const char *text) {
    printf("%s%s%s", ANSI_CYAN, text, ANSI_RESET);
}
